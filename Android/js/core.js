...
(function (DM) {
  ...
  // 战场固定 16:9:手机横屏近乎铺满,桌面 16:9 显示器也刚好占满。
  // 竖向仍取 660,重力/蓄力/落速等以高度为基准的物理量因此完全不变。
  DM.H = 660;
  DM.ASPECT = 16 / 9;
  DM.W = Math.round(DM.H * DM.ASPECT);
  // 早期关卡曲线是按 900 宽调的,凡是「随宽度增长」的量都用它归一
  DM.REF_W = 900;
  DM.W_SCALE = DM.W / DM.REF_W;
  DM.WALL = 18;
  DM.CEIL = 14;
